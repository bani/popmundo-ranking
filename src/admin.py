...
class Create(webapp.RequestHandler):
    ...
    def get(self):
        ...
        heavymetal.put()
        eletronica = Genre(id=7, name='Eletronica', bands=[209379,902742,1188719,129130,93848,828030,1306258,12085,883108,1476371,1404501,1051638,953840,88709,520897,1722167,1338341,53562,1411183,635238,1517085,249924,798289,14731,89809,532295,45109,1639623,457800,477559,387106,59564], lastUpdate=datetime.date.today())
        eletronica.put()
